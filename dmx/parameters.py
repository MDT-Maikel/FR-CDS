...
gMED = Parameter(name = 'gMED',
                 nature = 'internal',
                 type = 'real',
                 value = '2*cmath.pi',
                 texname = 'g_{\\text{MED}}')

MMED = Parameter(name = 'MMED',
                 nature = 'internal',
                 type = 'real',
                 value = 'gMED*Lambda',
                 texname = 'M_{\\text{MED}}')
