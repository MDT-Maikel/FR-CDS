...
GC_16 = Coupling(name = 'GC_16',
                 value = 'complex(0,1)*gMED',
                 order = {'NP':1})

GC_17 = Coupling(name = 'GC_17',
                 value = '2*complex(0,1)*gMED',
                 order = {'NP':1})
...
GC_62 = Coupling(name = 'GC_62',
                 value = '(2*complex(0,1))/Lambda',
                 order = {'NP':1})

GC_63 = Coupling(name = 'GC_63',
                 value = 'complex(0,1)/(16.*cmath.pi**2*Lambda**2)',
                 order = {'NP':2})

GC_64 = Coupling(name = 'GC_64',
                 value = '-G/(16.*cmath.pi**2*Lambda**2)',
                 order = {'NP':2,'QCD':1})
